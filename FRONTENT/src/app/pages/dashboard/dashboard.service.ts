...
export class DashboardService {
  ...
  //Phương thức chung
  DTSU666_Moment(fields: string): Observable<Array<DashBoardModel>> {
    ...
    return this.http.get<Array<DashBoardModel>>(url);
  }
  ...
  DTSU666_uimoment(): Observable<Array<DashBoardModel>> {
    return this.DTSU666_Moment(this.dtsu666_ui);
  }

  //---------------Công suất theo pha: p,q ; Cosphi ; Hz ----------------
  DTSU666_pqphimoment(): Observable<Array<DashBoardModel>> {
    return this.DTSU666_Moment(this.dtsu666PQPhiMomentFields);
  }
 
  //-------------Công suất -------------------
  DTSU666_amoment(): Observable<Array<DashBoardModel>> {
  ...
  //---------------Điện áp pha ----------------
  DTSU666_dienappha_today(): Observable<Array<DashBoardModel>> {
    const startDate = moment().startOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const endDate = moment().endOf('day').format("YYYY-MM-DDTHH:mm:ss");
  ...
  //---------------Dòng điện pha ----------------
  DTSU666_dongdienpha_today(): Observable<Array<DashBoardModel>> {
    const startDate = moment().startOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const endDate = moment().endOf('day').format("YYYY-MM-DDTHH:mm:ss");
  ...
  //---------------P tieu thu pha----------------
  DTSU666_ptieuthupha_today(): Observable<Array<DashBoardModel>> {
    const startDate = moment().startOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const endDate = moment().endOf('day').format("YYYY-MM-DDTHH:mm:ss");
  ...
  DTSU666_dienangtieuthu_today(): Observable<Array<DashBoardModel>> {
    const startDate = moment().startOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const endDate = moment().endOf('day').format("YYYY-MM-DDTHH:mm:ss");
  ...
  //-------------------------------------DTSU666_LAST WEEK------------------------------
  getDTSU666Data(lastNDays: number): Observable<Array<DashBoardModel>> {
  ...
  DTSU666_last1day(): Observable<Array<DashBoardModel>> {
    return this.getDTSU666Data(1);
  }

  DTSU666_last2day(): Observable<Array<DashBoardModel>> {
    return this.getDTSU666Data(2);
  }

  DTSU666_last3day(): Observable<Array<DashBoardModel>> {
    return this.getDTSU666Data(3);
  }

  DTSU666_last4day(): Observable<Array<DashBoardModel>> {
    return this.getDTSU666Data(4);
  }

  DTSU666_last5day(): Observable<Array<DashBoardModel>> {
    return this.getDTSU666Data(5);
  }

  DTSU666_last6day(): Observable<Array<DashBoardModel>> {
    return this.getDTSU666Data(6);
  }

  DTSU666_last7day(): Observable<Array<DashBoardModel>> {
  ...
  //-------- DTSU666-FILTER DATE----------
  // Bảng chi tiết
  DTSU666_getalll(fields: string): Observable<Array<DashBoardModel>> {
    const url = `${this.BaseUrl}/dtsu666?Fields=${fields}`;
    return this.http.get<Array<DashBoardModel>>(url);
  }
  DTSU666_bangcustom(date1: string, date2: string): Observable<Array<DashBoardModel>> {
  ...
  // Điện áp pha 
  DTSU666_dienapphacustom(date1: string, date2: string): Observable<Array<DashBoardModel>>{
    const startDate = moment(date1).startOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const endDate = moment(date2).endOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const url = `${this.BaseUrl}/dtsu666?Fields=Ua,Ub,Uc,Date&start=${startDate}&end=${endDate}`;
    return this.http.get<Array<DashBoardModel>>(url);
  ...
  // Dòng điện pha 
  DTSU666_dongienphacustom(date1: string, date2: string): Observable<Array<DashBoardModel>> {
    const startDate = moment(date1).startOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const endDate = moment(date2).endOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const url = `${this.BaseUrl}/dtsu666?Fields=Ia,Ib,Ic,Date&start=${startDate}&end=${endDate}`;
    return this.http.get<Array<DashBoardModel>>(url);
  ...
  // Công suất tiêu thụ 
  DTSU666_cstieuthucustom(date1: string, date2: string): Observable<Array<DashBoardModel>> {
    const startDate = moment(date1).startOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const endDate = moment(date2).endOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const url = `${this.BaseUrl}/dtsu666?Fields=Pft,Pfa,Pfb,Pfc,Date&start=${startDate}&end=${endDate}`;
    return this.http.get<Array<DashBoardModel>>(url);
  ...
  // Điện năng tiêu thụ 
  DTSU666_atieuthucustom(date1: string, date2: string): Observable<Array<DashBoardModel>> {
    const startDate = moment(date1).startOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const endDate = moment(date2).endOf('day').format("YYYY-MM-DDTHH:mm:ss");
    const url = `${this.BaseUrl}/dtsu666?Fields=A_sum,A_imp,A_exp,Date&start=${startDate}&end=${endDate}`;
    return this.http.get<Array<DashBoardModel>>(url);
